...
export function PostJobForm() {
  ...
  if (postedJob) {
    return (
      <div className="rounded-2xl border border-green-500/60 bg-surface p-6 md:p-8">
        <h2 className="mb-2 text-3xl font-bold text-green-400">Job Posted Successfully</h2>
        <p className="mb-6 text-text-secondary">
          <span className="font-semibold text-text-primary">{postedJob.title}</span> is now live.
        </p>
  ...
  return (
    <form onSubmit={onSubmit} className="rounded-2xl border border-border bg-surface p-5 md:p-8">
      <div className="grid grid-cols-1 gap-5 md:grid-cols-2">
        ...
        <div>
          <label className="mb-2 block text-sm text-text-secondary">Company Name *</label>
          <input
        ...
        <div>
          <label className="mb-2 block text-sm text-text-secondary">Company Email *</label>
          <input
            type="email"
        ...
        <div>
          <label className="mb-2 block text-sm text-text-secondary">City *</label>
          <input
        ...
        <div>
          <label className="mb-2 block text-sm text-text-secondary">State *</label>
          <input
        ...
        <div className="md:col-span-2">
          <label className="mb-2 block text-sm text-text-secondary">Job Type *</label>
          <select
        ...
        <div className="md:col-span-2">
          <p className="mb-2 text-sm text-text-secondary">Trades * (Select one or more)</p>
